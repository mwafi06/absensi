        ...
        <div class="panel panel-inverse" data-sortable-id="table-basic-1">
          ...
          <div class="form-group">
            ...
            <div class="radio radio-css radio-inline">
              <input type="radio" {{ $karyawan->j_kel == 'Laki-Laki' ? 'checked' : ''}} id="Radio1" name="j_kel" value="Laki-Laki"/>
               <label for="Radio1">Laki-Laki</label>
            </div>
            <div class="radio radio-css radio-inline">
              <input type="radio" value="Perempuan" {{ $karyawan->j_kel == 'Perempuan' ? 'checked' : ''}} id="Radio2" name="j_kel"/>
